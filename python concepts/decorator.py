...
# TO SEND THE FUNCTION AS AN ARGUMENT WE NEED TO CALL THE DECORATOR FUNCTION NAME AND PASS THE FUNCTION NAME AS ARG
...
# WE ALSO USE FUNCTOOL TO AVOID THE INTROSPECTOR TO TELL OUT THE DECORATION FUNCTION INSTEAD OF FUNCTION WE CALL
