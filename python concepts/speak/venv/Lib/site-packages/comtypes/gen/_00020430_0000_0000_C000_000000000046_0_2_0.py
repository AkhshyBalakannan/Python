...
IFontDisp = Font
__all__ = [ 'IPicture', 'FONTSIZE', 'OLE_XSIZE_CONTAINER',
           'OLE_XPOS_HIMETRIC', 'OLE_YPOS_CONTAINER',
           'OLE_ENABLEDEFAULTBOOL', 'Color', 'IFontEventsDisp',
           'OLE_XPOS_PIXELS', 'FONTUNDERSCORE', 'FontEvents',
           'OLE_COLOR', 'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_PIXELS',
           'FONTSTRIKETHROUGH', 'OLE_YPOS_HIMETRIC', 'FONTITALIC',
           'FONTNAME', 'Default', 'IFontDisp', 'Monochrome',
           'FONTBOLD', 'LoadPictureConstants', 'OLE_OPTEXCLUSIVE',
           'Checked', 'StdPicture', 'OLE_YSIZE_PIXELS',
           'OLE_YSIZE_HIMETRIC', 'IPictureDisp', 'StdFont',
           'OLE_XPOS_CONTAINER', 'OLE_CANCELBOOL',
           'OLE_XSIZE_HIMETRIC', 'Unchecked', 'OLE_YPOS_PIXELS',
           'Font', 'Gray', 'IFont', 'Picture', 'OLE_TRISTATE',
           'OLE_HANDLE', 'VgaColor']
